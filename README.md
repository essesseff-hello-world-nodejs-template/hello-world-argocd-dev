...
├── offboarding/
│   └── offboard-essesseff-hello-world-nodejs-template.sh # script for offboarding the {{K8S_NAMESPACE}} namespace from K8s
...
1. **Git Clone This Repository**:
   ```bash
   git clone git@github.com:essesseff-hello-world-nodejs-template/hello-world-argocd-dev.git
   ```
...
- **Config DEV**: `https://github.com/essesseff-hello-world-nodejs-template/hello-world-config-dev`
- **Argo CD DEV**: `https://github.com/essesseff-hello-world-nodejs-template/hello-world-argocd-dev` (this repo)
